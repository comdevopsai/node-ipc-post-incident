---
title: "The Trusted npm Package That Turned Malicious"
subtitle: "In May 2026, three malicious node-ipc releases appeared on npm while the upstream project still showed 12.0.0. The gap exposed how much modern software depends on trust outside the code we can see."
date: "2026-08-30"
category: "Software Supply Chain"
hero_image: "01-source-vs-distribution.png"
description: "The 2026 node-ipc incident began with an ordinary-looking repository and malicious releases in the official npm channel. What followed was a lesson in publishing identity, inherited trust, and software supply-chain risk."
---
...
**SOFTWARE SUPPLY CHAIN · MAY 2026 · LONG READ**

<figure>
  <img src="01-source-vs-distribution.png" alt="Editorial visualization showing the upstream RIAEvangelist node-ipc repository at version 12.0.0 while malicious versions appear through npm." />
  <figcaption><em>The source repository still looked familiar. The distribution channel was telling a different story.</em></figcaption>
</figure>
...
<figure>
  <img src="03-multiple-layers-of-trust.png" alt="Radial diagram showing node-ipc at the center of developer, CI, and credential trust layers." />
  <figcaption><em>A package can be small while the environment around it is enormously valuable.</em></figcaption>
</figure>
...
<figure>
  <img src="02-two-day-shockwave.png" alt="Timeline of the node-ipc incident across May 14 and May 15, 2026." />
  <figcaption><em>The story moved from malicious publication to public investigation and containment in roughly two days.</em></figcaption>
</figure>
...
<figure>
  <img src="04-trust-chain.png" alt="Trust chain diagram from identity and publishing through package, runtime, secrets, and network." />
  <figcaption><em>The software supply chain is a sequence of connected trust decisions, not a single security boundary.</em></figcaption>
</figure>
